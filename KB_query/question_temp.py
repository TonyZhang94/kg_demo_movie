...
rules = [
    ...
    Rule(condition_num=3, condition=person_entity + Star(Any(), greedy=False) + genre + actor + Star(Any(), greedy=False), action=QuestionSet.is_specific_genre_actor_question),
...
person_genre_type_rules = [
    KeywordRule(condition=person_entity + Star(Any(), greedy=False) + comedy + actor + Star(Any(), greedy=False), action=PropertyValueSet.return_comedian_iris),
    KeywordRule(condition=person_entity + Star(Any(), greedy=False) + action + actor + Star(Any(), greedy=False), action=PropertyValueSet.return_kungfuactor_iris)
]
